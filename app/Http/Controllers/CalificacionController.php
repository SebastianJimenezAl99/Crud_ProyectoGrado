...
class CalificacionController extends Controller
{
    ...
    public function index()
    {
        ...
        foreach ($calificacions as $calificacion) {
            $proyecto = Proyecto::find($calificacion->idProyecto);
            $calificacion->proyecto = $proyecto->titulo;
    ...
    public function create()
    {
        ...
        return view('calificacion.create', compact('calificacion', 'proyectos'));
    }
    ...
    {
        request()->validate([
            'idProyecto' => 'required|unique:calificacions',
    ...
    public function show($id)
    {
        ...
        $proyecto = Proyecto::find($calificacion->idProyecto);
            $calificacion->proyecto = $proyecto->id.' - '.$proyecto->titulo;
    ...
    public function edit($id)
    {
        $calificacion = Calificacion::find($id);
        $proyectos = Proyecto::all();
        return view('calificacion.edit', compact('calificacion', 'proyectos'));
    }
